...
📑[BIO: The Bao I/O Coprocessor](bunniestudios.com/blog/2026/bio-the-bao-i-o-coprocessor/)
...
🌐[PICO Z80 New](https://www.cnx-software.com/2026/03/26/
picoz80-a-z80-microprocessor-drop-in-replacement-based-on-raspberry-pi-rp2350b-and-esp32/)

🌐[PICO Z80 Original Source](https://eaw.app/picoz80/)
...
📑[田忌賽馬](https://zh.wikipedia.org/zh-tw/%E7%94%B0%E5%BF%8C)
...
📑[Chernobyl Fungus Seems to Have Evolved an Incredible Ability](https://www.sciencealert.com/chernobyl-fungus-seems-to-have-evolved-an-incredible-ability)
...
![](../images/2026/Screenshot%20from%202026-03-26%2016-19-01.png)

![](../images/2026/Screenshot%20from%202026-03-26%2016-17-27.png)

🌐[haasoscope-pro](https://www.crowdsupply.com/andy-haas/haasoscope-pro)

---

### Functional Specification Document

🌐[Functional Specification Document](https://www.modernrequirements.com/blogs/functional-specification-document/)

---

### AI-Driven ESP32 Workflow (Spec → Code → Test) using Claude Code

🎬[AI-Driven ESP32 Workflow (Spec → Code → Test) using Claude Code](https://www.youtube.com/watch?v=nmGEedloQ6E)

📑[Sample FSD](https://github.com/SensorsIot/IOS-Keyboard/blob/main/Documentation/IOS-Keyboard-fsd.md)

---

### 伊朗五條件

1. 敵方的「侵略與暗殺」行動必須全面停止。

2. 建立具體機制，確保戰爭不會再次對伊斯蘭共和國發動。

3. 保證並明確定義戰爭損害賠償與賠款的支付方式。

4. 全面結束所有戰線的軍事行動，並終結捲入這場戰爭的所有區域性反抗團體(resistance groups)。

5. 伊朗對荷姆茲海峽行使主權，現在是、未來也會是伊朗天然且合法的權利；這是另一方履行承諾的保證，必須獲得國際認可。
...
![](../images/2026/Screenshot%20from%202026-03-24%2017-07-21.png)

![](../images/2026/Screenshot%20from%202026-03-24%2017-05-58.png)
...
💾[Use positional data to improve commutator precision](https://github.com/open-ephys/bonsai-commutator/issues/18)

💾[Replace quaternion to twist with new algorithm](https://github.com/open-ephys/bonsai-commutator/pull/14)
...
📚[ESP32-P4-Nano](https://www.waveshare.net/wiki/ESP32-P4-Nano-StartPage)
...
💾[piBrick CM5](https://github.com/amarullz/piBrick/blob/main/Pocket-CM5/README.md)
...
🌐[OpenClaw on Raspberry Pi](https://learn.adafruit.com/openclaw-on-raspberry-pi)
...
🌐[Support Jacket 日本製外骨骼型輔助套裝(最強規格款)](https://www.momoshop.com.tw/goods/GoodsDetail.jsp?i_code=13508627)
...
🌐[Configuring Your Pi for I2C](https://learn.adafruit.com/mcp4725-12-bit-dac-with-raspberry-pi/configuring-your-pi-for-i2c)
