...
📑[Built-in Self Tests (BIST)](https://billkarsh.github.io/SpikeGLX/Sgl_help/BIST_Help.html)

![](../images/2026/NPDataPath.png)
...
The VESD pin should normally be tied to ground for safety
and noise reasons. A high-energy ESD event could
potentially short out any ESD diode. If VESD is tied to
ground, then severe damage to any diode will only short
the associated electrode to ground. Since any tissue
contacted by electrodes should be grounded, no DC
current will flow into the tissue. If, instead, VESD is tied to
a voltage above ground, no significant current will flow
under normal conditions since the corresponding diode will
be reverse biased. However, if that diode is damaged in
an ESD event, the voltage at VESD will be tied directly to
the electrode, possibly resulting in high DC currents and
tissue damage.
...
🌐[LED power tuning for fiber photometry](https://blog.mohebial.com/led-power-tuning-for-fiber-photometry/)

---

### Acquiring Head Orientation through using an IMU with Madgwick Orientation Filtering

[Acquiring Head Orientation through using an IMU](https://essay.utwente.nl/fileshare/file/98670/Jansen_BA_BSS.pdf)

---

### Towards Low-Latency Event-based Obstacle Avoidance on a FPGA-Drone

[Towards Low-Latency Event-based Obstacle Avoidance on a FPGA-Drone](https://openaccess.thecvf.com/content/CVPR2025W/EventVision/papers/Bonazzi_Towards_Low-Latency_Event-based_Obstacle_Avoidance_on_a_FPGA-Drone_CVPRW_2025_paper.pdf)

---

### Seeing the World Differently: How FPGA and Event-Based Vision are Transforming Robotics

[Seeing the World Differently: How FPGA and Event-Based Vision are Transforming Robotics](https://promwad.com/news/fpga-powered-vision-event-based-cameras-real-time-robotics-perception)

---

### ASTEF: FPGA-Based Enhancement of Event Camera Performance in Low-Light Conditions

📑[ASTEF: FPGA-Based Enhancement of Event Camera Performance in Low-Light Conditions](https://ieeexplore.ieee.org/document/11008995)

---

### Combined Physics and Event Camera Simulator for Slip Detection

📑[Combined Physics and Event Camera Simulator for Slip Detection](https://arxiv.org/abs/2503.04838)

---

### Real-time event simulation with frame-based cameras

📑[Real-time event simulation with frame-based cameras](https://arxiv.org/abs/2209.04634)
...
💾[AI Edge Gallery Agent Skills](https://github.com/google-ai-edge/gallery/tree/main/skills)
...
[Fully Fine-tune a Small Language Model with Hugging Face Tutorial](https://www.learnhuggingface.com/notebooks/hugging_face_llm_full_fine_tune_tutorial)
...
🌐[Toolboxes for GenAI on AMD Ryzen AI MAX+](https://strix-halo-toolboxes.com/)
...
🌐[Event-based Vision Resources](https://github.com/uzh-rpg/event-based_vision_resources/tree/master)
