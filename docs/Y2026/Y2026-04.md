...
💾[DSPi](https://github.com/WeebLabs/DSPi)
...
💾[Gemma 4 FPGA Artifact Bundle](https://github.com/n57d30top/gemma4-on-FPGA)
...
💾[PICO Cluster](https://github.com/willowec/pico_cluster)

---

## 2026-04-28 Tuesday 🌐 🎬 💾 📚 📑 🔬

### Aeon: an open-source platform to study the neural basis of ethological behaviours over naturalistic timescales (UCL)
...
💾[MIPI to HDMI](https://github.com/FHDO-ICLAB/MIPI-CSI-2-HDMI-Bridge)
...
💾[ESP32-P4 UVC Webcam + RTSP IP Camera](https://github.com/r4d10n/esp32p4-uvc-video)
...
💾[PicoCalc Program use Arduino](https://github.com/CptnRoughnight/PicoCalc-basecode)
...
🌐[An ant colony has memories that its individual members don’t have](https://bigthink.com/neuropsych/an-ant-colony-has-memories-that-its-individual-members-dont-have-2624819695/#rebelltitem2)

🌐[Ants vs. Humans: Putting Group Smarts to the Test](https://www.weizmann.ca/ants-vs-humans-putting-group-smarts-to-the-test/)

🌐[Ant colonies behave like neural networks when making decisions](https://www.rockefeller.edu/news/32489-ant-colonies-behave-like-neural-networks-when-making-decisions/)
...
💾[AMLib](https://github.com/amaranth-farm/amlib)
...
```py
user_code = input("Enter Python code to run: ") # e.g., print(5 + 5)
exec(user_code) 
```
