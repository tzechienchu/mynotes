...
💾[I3C Open Core](https://github.com/chipsalliance/i3c-core)
...
📚[Open-Source FPGA Implementation of an I3C Controller](../papers/2026/chips-04-00006-v2.pdf)

---

### FPGA Power Source PMIC（電源管理晶片）
...
### KryonOS a JavaScript OS

[KryonOS](https://github.com/Haris16-code/KryonOS)
...
### Spire: An HDL with Optimization Built In (Felix Arnold)

🎬[Spire: An HDL with Optimization Built In (Felix Arnold)](https://www.youtube.com/watch?v=9N2l1K45lFk)

💾[Spire HDL](https://github.com/huawei-csl/spire-hdl)
...
💾[RTL Scout](https://github.com/huawei-csl/rtlscout)

An RTL design agent powered by selectable LLM backends (DeepInfra, Anthropic, OpenRouter) with tool use. The agent iteratively creates and optimizes Verilog/SystemVerilog, Spire HDL or Amaranth designs, targeting correctness first, then minimal cost under a configurable cost metric. The agent can run as the built-in in-process loop or as an external OpenCode agent in a sandboxed, per-run container.

---

### Open-Source FPGAs: Tools, Flows, and Visualization (Alex Singer)

🎬[Open-Source FPGAs: Tools, Flows, and Visualization (Alex Singer)](https://www.youtube.com/live/ZbUCm6wvwfM?t=4s)
...
💾[MicroPython Debugger](https://github.com/ghi-electronics/micropython-vsc-extension)
...
![](../images/2026/Screenshot%20from%202026-09-21%2011-44-18.png)

🌐[Invisible Labors of Creativitiy](https://www.themarginalian.org/2026/09/20/leo-lionni-frederick/)

---

### Why fitting a logistic is nearly impossible from early data

![](../images/2026/Screenshot%20from%202026-09-21%2010-16-26.png)
...
### FRANK : Hardware emulation platform based on Raspberry Pi Pico

🌐[FRANK](https://frank.rh1.tech/)

Hardware emulation platform based on Raspberry Pi Pico

Emulate retro computers, game consoles, and more. From ZX Spectrum to NES, from IBM PC to DOOM. Build yours for around $20.

💾[Frank-386](https://github.com/rh1tech/frank-386)

---

### Continual Backprop

📚[Continual Backprop:Stochastic Gradient Descent with Persistent Randomness](../papers/2026/2108.06325v3.pdf)

Weigh Change with different time steps (Dynamics).

In brain, synapes come and go. In differnet timescale.

I like this idea. But, I don't like backprop.
...
![](../images/2026/81ldXAYBccL._AC_UF894,1000_QL80_.jpg)
...
### WCH USB3 Solution Chip and Interface

#### CH32H417 UHSIF 

#### CH569 HSPI High Speed Parallel Interface

---

### 小梅哥 FPGA & CH569 Board Data

📑[Zynq + CH569](https://fpga.cn/forum.php?mod=forumdisplay&fid=127)

📑[All FPGA](https://fpga.cn/forum.php?mod=viewthread&tid=27978&extra=page%3D1)

---

### WCH MCU for Rust

💾[WCH MCU for Rust](https://github.com/ch32-rs)

Rust support projects for WCH's 32-bit microcontrollers

---

### CH569 Phantomdrive

🌐[CH569 Phantomdrive](https://rootkitlabs.com/2026/06/22/I%27m-Building-a-Secure-USB-Drive/)
...
💾[ch569-usb3-hspi-bridge](https://github.com/hansfbaier/ch569-usb3-hspi-bridge/tree/main)

💾[Gateware for the WCH-Tech CH569 High Speed Parallel Interface (HSPI)](https://github.com/amaranth-farm/ch569-hspi-fpga)

💾[ch569-hspi-loopback](https://github.com/hansfbaier/ch569-hspi-loopback)

💾[CH569 USB3 Super Speed Board](https://github.com/hansfbaier/ch569-usb3-board)
...
🎬[PlayBook: A Programmable Paper Notebook](https://www.youtube.com/watch?v=GurWDZ8ENpA)

🌐[PlayBook History](https://www.inkandswitch.com/project/playbook/)

---

### Pulse : VHDL Simulator

💾[Pulse](https://github.com/oscar30gt/pulse)
...
🎬[紅樓夢 歐麗娟](https://ocw.aca.ntu.edu.tw/courses/101S120)
...
🎬[Photonic Integrated Circuits](https://www.youtube.com/watch?v=zM60Vs7GhVA)
